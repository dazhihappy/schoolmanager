...
//		for(int i = 0 ; i< 10 ;i++){
//			UserSkimTime userSkimTime = new UserSkimTime();
//			userSkimTime.set_id(new ObjectId());
//			userSkimTime.setStuId(new ObjectId());
//			userSkimTime.setLoginTime(new Date());
//			userSkimTime.setExitTime(new Date());
//			DaoImpl.InsertWholeBean(userSkimTime);
//		}
		
//		for(int i=2000;i<2020;i++){
//			Suggestion suggestion=new Suggestion();
//			suggestion.set_id(new ObjectId());
//			suggestion.setContent("编号为"+i+"学生账户丢失");
//			suggestion.setReleaseTime(new Date());
//			suggestion.setFrom("清华大学教务处");
//			suggestion.setState(0);
//			suggestion.setDealPerson(new ObjectId());
//			suggestion.setDealTime(new Date());
//			suggestion.setSolution("未处理");
//			DaoImpl.InsertWholeBean(suggestion);
//		}
		
		//DaoImpl.DeleteDocment(School.class, new BasicDBObject());
...
//		school.setState(false);
//		DaoImpl.InsertWholeBean(school);
//		DaoImpl.DeleteDocment(Organization.class, new BasicDBObject());
		
		Province province = new Province();
		province.set_id(new ObjectId());
		province.setName("江苏省");
		ArrayList<City> cities = new ArrayList<City>();
		for (int i = 0; i < 10; i++) {
			City city = new City();
			city.setName("江苏省"+"city"+i);
			cities.add(city);
		}
		province.setCity(cities);
		DaoImpl.InsertWholeBean(province);
	}	
