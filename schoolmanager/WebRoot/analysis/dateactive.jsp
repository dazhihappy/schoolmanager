		...
		$("#announcement").bind("click",function(){
			window.location.href="announcementbyday.jsp";
  			...
  			$("#before").bind("click",function(){           	
            	$.get("getActiveData",{"page":1,"time":$("#tomorrowDate").text(),"type":"day"},function(data){
            		var strs = new Array();
            		strs = data.split("~");
            		var xx = new Array();
            		xx = strs[0].split(",");
  			...
  			$("#after").bind("click",function(){
  				$.get("getActiveData",{"page":2,"time":$("#tomorrowDate").text(),"type":"day"},function(data){
            		var strs = new Array();
            		strs = data.split("~");
            		var xx = new Array();
            		xx = strs[0].split(",");
  		...
  		$(function(){
  			...
  			$.get("getActiveData",{"page":1,"time":$time,"type":"day"},function(data){
            	//alert(data);
            	var strs = new Array();
            	strs = data.split("~");
            	var xx = new Array();
